...
\lfoot{Lerntagebuch zu den Cousera MOOCs "'Android Development"' und dem Aquent Gymnasium Kurs "'Javascript Foundations"'}
\cfoot{}
...
\begin{center}
	...
	über das Thema\\
	\vspace*{1cm}
	\textbf{Lerntagebuch zu den Cousera MOOCs "'Android Development"' und dem Aquent Gymnasium Kurs "'Javascript Foundations"'}\\
	\vspace*{2cm}
	...
	\begin{tabular}{x{6cm}p{7.5cm}}
		...
		\rule{0mm}{5ex}\textbf{Abgabedatum:} & 13.07.2015 \\ 
	\end{tabular} 
\end{center}
\pagebreak
...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}[Hauptseite des Aquent Gymnasiums]{Hauptseite des Aquent Gymnasiums \footnotemark }
	\label{fig:osgi}
\end{minipage}
\footnotetext{Quelle: \url{http://gymnasium.aquent.com}}
...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}[Tutor des Kurses Keith Peters]{Tutor des Kurses Keith Peters \footnotemark }
	\label{fig:osgi}
\end{minipage}
\footnotetext{Quelle: \url{http://gymnasium.aquent.com}}
...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}[Mein Kursfortschritt]{Mein Kursfortschritt \footnotemark }
	\label{fig:osgi}
\end{minipage}
\footnotetext{Quelle: \url{http://gymnasium.aquent.com}}
...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}[Ergebniss Examen]{Ergebniss Examen \footnotemark }
	\label{fig:osgi}
\end{minipage}
\footnotetext{Quelle: \url{http://gymnasium.aquent.com}}
...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}[Zertifikat des JavaScript Kurses]{Zertifikat des JavaScript Kurses \footnotemark }
	\label{fig:osgi}
\end{minipage}
\footnotetext{Quelle: \url{http://gymnasium.aquent.com}}
